...
### ✅ MCP Server Starter
- **spring-ai-mcp-server-starter** : Transport par défaut HTTP (via REST endpoints).
- **spring-ai-starter-mcp-server-webmvc** : Permet de démarrer le MCP Server en SSE par défaut.
